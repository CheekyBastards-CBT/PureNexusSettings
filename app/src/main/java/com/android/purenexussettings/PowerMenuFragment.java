...
public class PowerMenuFragment extends PreferenceFragment {
    ...
    private static final String POWER_MENU_ACTIONS = "power_menu_actions";
    private static final String UPDATE_POWER_MENU = "android.intent.action.UPDATE_POWER_MENU";
    ...
    private void updatePreferences() {
        boolean bugreport = Settings.Secure.getInt(getActivity().getContentResolver(),Settings.Secure.BUGREPORT_IN_POWER_MENU, 0) != 0;
    ...
    private void getUserConfig() {
        ...
        String savedActions = Settings.Global.getStringForUser(mContext.getContentResolver(), POWER_MENU_ACTIONS, UserHandle.USER_CURRENT);

        if (savedActions == null) {
            defaultActions = mContext.getResources().getStringArray(com.android.internal.R.array.config_globalActionsList);
    ...
    private void saveUserConfig() {
        ...
        Settings.Global.putStringForUser(getActivity().getContentResolver(), POWER_MENU_ACTIONS, s.toString(), UserHandle.USER_CURRENT);
        updatePowerMenuDialog();
    }

    private void updatePowerMenuDialog() {
        Intent u = new Intent();
        u.setAction(UPDATE_POWER_MENU);
